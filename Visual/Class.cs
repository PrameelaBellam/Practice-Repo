    ...
    class Member
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != this.GetType())
                return false;
            Member m = (Member)obj;
            return (m.ContactNumber.Equals(this.ContactNumber,StringComparison.InvariantCultureIgnoreCase)) &&
                (m.Email.Equals(this.Email,StringComparison.InvariantCultureIgnoreCase));
        }
